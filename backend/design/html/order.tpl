                                            ...
                                            <div class="okay_list_row">
                                                ...
                                                <div class="okay_list_boding okay_list_order_name">
                                                    <div class="boxes_inline">
                                                        {if $purchase->product}
                                                            <a class="text_600 {if !$order->closed && $purchase->variant->stock_status == 'out_of_stock'}hint-bottom-middle-t-info-s-small-mobile  hint-anim text_500 text_warning{/if}" {if !$order->closed && $purchase->variant->stock_status == 'out_of_stock'}data-hint="{$btr->product_out_stock|escape}"{/if} href="{url controller=ProductAdmin id=$purchase->product->id}">{$purchase->product_name|escape}</a>
