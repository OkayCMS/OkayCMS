                ...
                <div class="toggle_body_wrap on fn_card">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <div class="mb-1">
                                <input class="form-control" type="text" name="okaycms__yandex_xml__company" value="{$settings->okaycms__yandex_xml__company|escape}" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                            ...
                            <div class="mb-1">
                                <input id="okaycms__yandex_xml_sales_notes" name="okaycms__yandex_xml__sales_notes" class="form-control" type="text" value="{$settings->okaycms__yandex_xml__sales_notes|escape}" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                            ...
                            <div class="mb-1">
                                <select name="okaycms__yandex_xml__country_of_origin" class="selectpicker">
                                    ...
                                    {foreach $features as $feature}
                                        <option {if $settings->okaycms__yandex_xml__country_of_origin == $feature->id}selected=""{/if} value="{$feature->id}">{$feature->name|escape}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
