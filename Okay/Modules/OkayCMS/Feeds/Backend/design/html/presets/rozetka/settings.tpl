    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__company}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__feed_name}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__variant_name_param}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_price}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_stock}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__rozetka__price_change}</strong>
