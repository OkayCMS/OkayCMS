...
$lang['np_cron_update_cache_1'] = 'In order for the data to be updated automatically, you should make sure that the server is configured to run the system task scheduler using cron:';
