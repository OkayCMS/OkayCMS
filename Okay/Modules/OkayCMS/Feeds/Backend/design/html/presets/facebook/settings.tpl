    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                ...
                {get_design_block block="okay_cms__feeds__feed__settings__facebook__switch_checkboxes"}
            </div>
        </div>
    </div>
</div>
...
<div class="boxed">
    <div class="heading_box mb-2">
        ...
        {get_design_block block="okay_cms__feeds__feed__settings__facebook__parameters"}
    </div>
</div>
