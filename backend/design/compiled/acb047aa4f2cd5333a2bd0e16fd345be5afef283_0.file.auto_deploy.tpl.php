<?php
/* Smarty version 3.1.40, created on 2025-11-26 19:38:11
  from '/var/www/html/Okay/Modules/OkayCMS/AutoDeploy/Backend/design/html/auto_deploy.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_69273b03e4fb58_59857851',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'acb047aa4f2cd5333a2bd0e16fd345be5afef283' => 
    array (
      0 => '/var/www/html/Okay/Modules/OkayCMS/AutoDeploy/Backend/design/html/auto_deploy.tpl',
      1 => 1764098168,
      2 => 'file',
    ),
  ),
...
function content_69273b03e4fb58_59857851 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_assignInScope('meta_title', $_smarty_tpl->tpl_vars['btr']->value->auto_deploy_title ,false ,32);?>

<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->auto_deploy_title, ENT_QUOTES, 'UTF-8', true);?>
        ...
        <div class="match_matchHeight_true">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="boxed" style="max-width: 800px;margin: 0 auto;">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel && $_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel != 'local') {?>
                            <form method="post" enctype="multipart/form-data" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'OkayCMS.AutoDeploy.AutoDeployAdmin@updateProject'),$_smarty_tpl ) );?>
">
...
" />
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value->deploy_last_status_text) {?>
                            <a href="#last_deploy_log" class="fn_fancybox_button">Лог последней сборки проекта</a>
                            <div style="display:none;">
                                <div id="last_deploy_log" style="min-width: 500px;min-height: 300px;"><?php echo nl2br($_smarty_tpl->tpl_vars['settings']->value->deploy_last_status_text);?>
</div>
                            </div>
                        <?php }?>
...
IdentityFile ~/.ssh/bitbucket_rsa
                        ...
                        <p>
                            ...
                            <br>
                            <div class="form-group">
                                <input id="local_channel" type="radio" name="deploy_build_channel" value="local"<?php if (!$_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel || $_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel == 'local') {?> checked<?php }?>>
                                <label for="local_channel"><b>local</b> Разработка на локальной машине</label>
                            </div>
                            <div class="form-group">
                                <input id="dev_channel" type="radio" name="deploy_build_channel" value="dev"<?php if ($_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel == 'dev') {?> checked<?php }?>>
                                <label for="dev_channel"><b>dev</b> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_AutoDeploy_build','channel'=>'dev','buildKey'=>$_smarty_tpl->tpl_vars['settings']->value->deploy_build_key,'absolute'=>1),$_smarty_tpl ) );?>
</label>
                            </div>
                            <div class="form-group"><div>
                                <input id="production_channel" type="radio" name="deploy_build_channel" value="production"<?php if ($_smarty_tpl->tpl_vars['settings']->value->deploy_build_channel == 'production') {?> checked<?php }?>>
                                <label for="production_channel"><b>production</b> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_AutoDeploy_build','channel'=>'production','buildKey'=>$_smarty_tpl->tpl_vars['settings']->value->deploy_build_key,'absolute'=>1),$_smarty_tpl ) );?>
</label>
                            </div>
                        ...
                        <p>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['new_migrations']->value) {?>
                                <div class="fn_new_migrations">
                                    <b>У вас есть невыполненные миграции:</b>
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['new_migrations']->value, 'migration');
$_smarty_tpl->tpl_vars['migration']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['migration']->value) {
$_smarty_tpl->tpl_vars['migration']->do_else = false;
?>
                                        <div><b><?php echo $_smarty_tpl->tpl_vars['migration']->value['name'];?>
</b></div>
                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <?php }?>
                            <b<?php if ($_smarty_tpl->tpl_vars['new_migrations']->value) {?> style="display: none"<?php }?> class="fn_all_migrations_executed">У вас все миграции выполнены.</b>
                        </p>
                        <p>
...
>
    ...
    $('.fn_create_migration').on('click', function () {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: "<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'OkayCMS.AutoDeploy.AutoDeployAdmin@createMigration'),$_smarty_tpl ) );?>
",
            data: {
...
',
    ...
    $('input[name="deploy_build_channel"]').on('change', function () {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: "<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'OkayCMS.AutoDeploy.AutoDeployAdmin@saveChannel'),$_smarty_tpl ) );?>
",
            data: {
                channel: $(this).val(),
                session_id: '<?php echo $_SESSION['id'];?>
',
    ...
    $('.fn_execute_migrations').on('click', function () {
        $.ajax({
            dataType: 'json',
            url: "<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('controller'=>'OkayCMS.AutoDeploy.AutoDeployAdmin@executeMigrations'),$_smarty_tpl ) );?>
",
            success: function (data) {
