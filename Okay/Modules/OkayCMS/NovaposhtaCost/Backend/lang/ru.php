...
$lang['np_cron_update_cache_1'] = 'Для того, чтобы данные обновлялись автоматически, вам следует убедится, что на сервере настроено выполнение с помощью cron следующего скрипта:';
