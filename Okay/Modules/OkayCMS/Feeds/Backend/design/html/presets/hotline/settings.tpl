<div class="boxed">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed_settings__hotline__price_change}</strong>
                <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed_settings__hotline__price_change_tooltip|escape}">
