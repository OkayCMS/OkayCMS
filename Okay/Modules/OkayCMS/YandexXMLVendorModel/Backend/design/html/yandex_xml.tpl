                        ...
                        <div class="permission_boxes row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span>{$btr->okaycms__yandex_xml_vendor_model__upload_without_images|escape}</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="okaycms__yandex_xml_vendor_model__upload_without_images" value='1' type="checkbox" {if $settings->okaycms__yandex_xml_vendor_model__upload_without_images}checked=""{/if}/>
