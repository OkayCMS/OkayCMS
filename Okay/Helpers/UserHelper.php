...
class UserHelper
{
     ...
     *
     * @param bool $onlyToLocal Объединять только с базы в локальное хранилище
    ...
    public function mergeBrowsedProducts($onlyToLocal = false)
    {
        ...
        if ($onlyToLocal === true) {
            $this->deleteBrowsedProductsCookie();
    ...
    private function deleteBrowsedProductsCookie(): void
    {
