...
/* Smarty version 3.1.40, created on 2025-11-26 11:33:18
  from '/var/www/html/backend/design/html/order_discount.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_6926c95e45e243_59934875',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de418f474a3d6f51a743f76afb42bc69f1a71169' => 
    array (
      0 => '/var/www/html/backend/design/html/order_discount.tpl',
      1 => 1764098168,
      2 => 'file',
    ),
  ),
...
function content_6926c95e45e243_59934875 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="okay_list fn_order_discounts_block" <?php if (!$_smarty_tpl->tpl_vars['discounts']->value) {?>style="display: none;"<?php }?>>
    <div class="okay_list_head">
        <div class="okay_list_heading okay_list_drag"></div>
        <div class="okay_list_heading okay_list_order_discounted_name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discounts_name, ENT_QUOTES, 'UTF-8', true);?>
</div>
        <div class="okay_list_heading okay_list_count"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discounts_procedure, ENT_QUOTES, 'UTF-8', true);?>
<i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discount_from_last_discount_tooltip, ENT_QUOTES, 'UTF-8', true);?>
">
...
?>
        ...
        <div class="okay_list_heading okay_list_price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discounts_value, ENT_QUOTES, 'UTF-8', true);?>
</div>
        <div class="okay_list_heading okay_list_order_amount_price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discounts_total, ENT_QUOTES, 'UTF-8', true);?>
</div>
...
" />
                    <input type="hidden" name="order_discounts[id][]" value="<?php echo $_smarty_tpl->tpl_vars['discount']->value->id;?>
" />
...
?>
                    ...
                    <div class="okay_list_boding okay_list_order_discounted_name">
                        <div class="form_create">
                            <input  name="order_discounts[name][]" class="form-control input_create text_600" type="text" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discount']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
">
                        ...
                        <div class="form_create">
                            <input name="order_discounts[description][]" class="form-control input_create text_grey text_400 font_12" type="text" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discount']->value->description, ENT_QUOTES, 'UTF-8', true);?>
...
">
                            ...
                            <div class="activity_of_switch_item">
                                <div class="okay_switch clearfix">
                                    <label class="switch switch-default">
                                        <input class="fn_discount_from_last_off" type="hidden" name="order_discounts[from_last_discount][]" value="0" <?php if ($_smarty_tpl->tpl_vars['discount']->value->fromLastDiscount) {?>disabled<?php }?>>
                                        <input class="fn_discount_from_last_on switch-input" name="order_discounts[from_last_discount][]" value="1" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['discount']->value->fromLastDiscount) {?>checked<?php }?>>
                    ...
                    <div class="okay_list_boding okay_list_price">
                        <div class="input-group">
                            <input type="text" class="form-control" name="order_discounts[value][]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discount']->value->value, ENT_QUOTES, 'UTF-8', true);?>
" />
                            <input class="fn_discount_type_input <?php if ($_smarty_tpl->tpl_vars['discount']->value->type == "percent") {?> active <?php }?>" type="hidden" name="order_discounts[type][]" value="percent" <?php if ($_smarty_tpl->tpl_vars['discount']->value->type == "absolute") {?>disabled<?php }?>/>
                            <input class="fn_discount_type_input <?php if ($_smarty_tpl->tpl_vars['discount']->value->type == "absolute") {?> active <?php }?>" type="hidden" name="order_discounts[type][]" value="absolute" <?php if ($_smarty_tpl->tpl_vars['discount']->value->type == "percent") {?>disabled<?php }?> />
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        <div class="fn_row okay_list_body_item fn_sort_item fn_new_order_discount">
            <div class="okay_list_row">
                ...
                <div class="okay_list_boding okay_list_order_discounted_name">
                    <div class="form_create">
                        <input  name="order_discounts[name][]" class="form-control input_create text_600" type="text" title="" placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discount_placeholder_name, ENT_QUOTES, 'UTF-8', true);?>
" value="">
                    </div>
                    <div class="form_create">
                        <input name="order_discounts[description][]" class="form-control input_create text_grey text_400 font_12" type="text" title="" placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_discount_placeholder_descr, ENT_QUOTES, 'UTF-8', true);?>
" value="">
                    </div>
                </div>
                <div class="okay_list_boding okay_list_count hidden-md-down">
...
?>
            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->order_add_new_discount, ENT_QUOTES, 'UTF-8', true);?>
</span>
        </button>
    </div>
</div>
