        ...
        <div class="permission_boxes row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__upload_without_images|escape}</span>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__upload_only_in_stock_products|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__store|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__pickup|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__use_full_description|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__has_manufacturer_warranty|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__no_export_without_price|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__delivery|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__adult|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__enable_auto_discounts|escape}</span>
                    <label class="switch switch-default">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="permission_box permission_box--long">
                    <span>{$btr->okay_cms__feeds__feed_settings__yml__count|escape}</span>
                    <label class="switch switch-default">
    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed_settings__yml__company}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed_settings__yml__feed_name}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed_settings__yml__country_of_origin}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed_settings__yml__filter_price}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed_settings__yml__filter_price_price}" disabled>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed_settings__yml__filter_stock}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed_settings__yml__filter_stock_stock}" disabled>
                        </div>
                        <div class="col-md-2">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed_settings__yml__price_change}</strong>
                <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed_settings__yml__price_change_tooltip|escape}">
