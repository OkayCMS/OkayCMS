    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__yml__company}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__yml__feed_name}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__yml__country_of_origin}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__yml__price_change}</strong>
