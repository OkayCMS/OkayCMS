                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_price][operator]">
                                <option value="<" {if $feed->settings['filter_price']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_price_price} {$btr->okay_cms__feeds__feed__settings__common__equality_less}</option>
                                <option value=">" {if $feed->settings['filter_price']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_price_price} {$btr->okay_cms__feeds__feed__settings__common__equality_large}</option>
                                <option value="=" {if $feed->settings['filter_price']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_price_price} {$btr->okay_cms__feeds__feed__settings__common__equality_equally1}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_stock][operator]">
                                <option value="<" {if $feed->settings['filter_stock']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings__common__equality_less}</option>
                                <option value=">" {if $feed->settings['filter_stock']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings__common__equality_large}</option>
                                <option value="=" {if $feed->settings['filter_stock']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__rozetka__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings__common__equality_equally2}</option>
                            </select>
                        </div>
                        <div class="col-xs-6 col-md-5 col-lg-4 col-lg-4">
