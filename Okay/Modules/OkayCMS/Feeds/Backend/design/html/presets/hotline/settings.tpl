    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__hotline__company}</span>
            </div>
            <div class="mb-1">
...
<div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                {$btr->okay_cms__feeds__feed__settings__hotline__guarantee_shop}
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__hotline__guarantee_manufacturer}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__hotline__upload_without_images|escape}</span>
                        </label>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span class="permission_box__label">{$btr->okay_cms__feeds__feed__settings__hotline__upload_only_in_stock_products|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span class="permission_box__label">{$btr->okay_cms__feeds__feed__settings__hotline__use_full_description|escape}</span>
                        </label>
                        <label class="switch switch-default">
    ...
    <div class="row">
        <div class="col-md-12 mb-q">
            <div class="row">
                <div class="col-md-12">
                    {* <div class="heading_label">
                        <span>{$btr->okay_cms__feeds__feed__settings__hotline__filter_price}</span>
                    </div> *}
                    <div class="row">
                        {* <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed__settings__hotline__filter_price_price}" disabled>
                        </div> *}
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_price][operator]">
                                <option value="<" {if $feed->settings['filter_price']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_less}</option>
                                <option value=">" {if $feed->settings['filter_price']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_large}</option>
                                <option value="=" {if $feed->settings['filter_price']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_equally1}</option>
                            </select>
                        </div>
                ...
                <div class="col-md-12">
                    {* <div class="heading_label">
                        <span>{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock}</span>
                    </div> *}
                    <div class="row">
                        {* <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock_stock}" disabled>
                        </div> *}
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_stock][operator]">
                                <option value="<" {if $feed->settings['filter_stock']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_less}</option>
                                <option value=">" {if $feed->settings['filter_stock']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_large}</option>
                                <option value="=" {if $feed->settings['filter_stock']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_equally2}</option>
                            </select>
                        </div>
                        <div class="col-xs-6 col-md-5 col-lg-4 col-lg-4">
        ...
        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__hotline__price_change}</span>
                <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed__settings__hotline__price_change_tooltip|escape}">
