    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__hotline__company}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__hotline__guarantee_manufacturer}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__hotline__country_of_origin}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__hotline__filter_price}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__hotline__filter_stock}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__hotline__price_change}</strong>
