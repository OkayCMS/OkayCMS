    ...
    {if $novaposhta_delivery_data->warehouse->name}
        <tr valign="top">
            <td class="es-p5t es-p5b" width="180px">
                <span>
                    {$lang->np_order_warehouse|escape}:
                </span>
            </td>
