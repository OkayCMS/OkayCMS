    ...
    <div class="boxed fn_features_settings hidden-xs-down">
        ...
        <div class="okay_list products_list fn_sort_list">
            ...
            <div class="okay_list_head">
                ...
                <div class="okay_list_heading okay_list_feed_features_settings_settings">{$btr->okay_cms__feeds__feed__categories_settings__table_settings}</div>
            </div>
            {*Параметры элемента*}
                ...
                {foreach $features as $feature}
                    <div class="okay_list_body_item fn_feature_settings">
                        <div class="okay_list_row">
                            <div class="okay_list_boding okay_list_feed_num">{$feature@iteration}.</div>
