...
/* Smarty version 3.1.40, created on 2025-11-26 14:34:01
  from '/var/www/html/Okay/Modules/OkayCMS/Hotline/Backend/design/html/hotline_xml.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_6926f3b9adfd74_81189387',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ae6c5a91342192a81cdedcaf345b444170a0b50e' => 
    array (
      0 => '/var/www/html/Okay/Modules/OkayCMS/Hotline/Backend/design/html/hotline_xml.tpl',
      1 => 1764098168,
      2 => 'file',
    ),
  ),
...
function content_6926f3b9adfd74_81189387 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'category_select' => 
  array (
    'compiled_filepath' => '/var/www/html/backend/design/compiled/ae6c5a91342192a81cdedcaf345b444170a0b50e_0.file.hotline_xml.tpl.php',
    'uid' => 'ae6c5a91342192a81cdedcaf345b444170a0b50e',
    'call_name' => 'smarty_template_function_category_select_6791571296926f3b9aa4398_24610724',
  ),
));
                ...
                <div class="toggle_body_wrap on fn_card">
                        ...
                        <div class="permission_boxes row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__upload_without_images, ENT_QUOTES, 'UTF-8', true);?>
</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="okaycms__hotline__upload_without_images" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['settings']->value->okaycms__hotline__upload_without_images) {?>checked=""<?php }?>/>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <div class="mb-1">
                                <input class="form-control" type="text" name="okaycms__hotline__company" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->okaycms__hotline__company, ENT_QUOTES, 'UTF-8', true);?>
" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-1">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__edit_and_add_feeds, ENT_QUOTES, 'UTF-8', true);?>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-info btn_big mb-1 fn_add_feed" type="submit" name="add_feed" value="1">
                            <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__add_feed;?>
</span>
                        </button>
                    </div>
                    <div class="col-md-12">
...
$__foreach_feed_3_saved = $_smarty_tpl->tpl_vars['feed'];
?>
...
" class="heading_box tab_navigation_link"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feed']->value->name, ENT_QUOTES, 'UTF-8', true);?>
                                    ...
                                    <?php
$_smarty_tpl->tpl_vars['feed'] = $__foreach_feed_3_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                </div>
                            </div>
...
$_smarty_tpl->tpl_vars['feed']->do_else = false;
$_smarty_tpl->tpl_vars['feed']->iteration++;
$__foreach_feed_4_saved = $_smarty_tpl->tpl_vars['feed'];
?>
                                                                ...
                                                                <div class="alert__content">
                                                                    <div class="alert__title">
                                                                        <?php if ((isset($_smarty_tpl->tpl_vars['errors']->value['feeds'][$_smarty_tpl->tpl_vars['feed']->value->id]['url']))) {?>
                                                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__error_url_exist, ENT_QUOTES, 'UTF-8', true);?>

                                                                        <?php } elseif ((isset($_smarty_tpl->tpl_vars['errors']->value['feeds'][$_smarty_tpl->tpl_vars['feed']->value->id]['url_cyrillic']))) {?>
                                                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__error_url_cyrillic, ENT_QUOTES, 'UTF-8', true);?>
...
">
                                                                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__remove_feed;?>
</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="heading_label">
                                                                <span>URL</span>
                                                                <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__error_url_cyrillic, ENT_QUOTES, 'UTF-8', true);?>
">
...
" readonly="readonly">
 ...
 <a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_Hotline_Feed','url'=>$_smarty_tpl->tpl_vars['feed']->value->url,'absolute'=>1),$_smarty_tpl ) );?>
" target="_blank"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_Hotline_Feed','url'=>$_smarty_tpl->tpl_vars['feed']->value->url,'absolute'=>1),$_smarty_tpl ) );?>
</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
...
"><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__select_all;?>
</button>
                                                                <button class="btn btn_small" name="remove_all_categories" value="<?php echo $_smarty_tpl->tpl_vars['feed']->value->id;?>
"><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__select_none;?>
</button>
                                                            </div>
                                                            <div class="toggle_body_wrap on fn_card">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <div class="boxed fn_toggle_wrap min_height_210px">
                                                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['backend_compact_product_list'][0], array( array('title'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__products_for_upload,'name'=>"related_products_".((string)$_smarty_tpl->tpl_vars['feed']->value->id),'products'=>$_smarty_tpl->tpl_vars['related_products']->value[$_smarty_tpl->tpl_vars['feed']->value->id],'label'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__add_products,'placeholder'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__select_products),$_smarty_tpl ) );?>
                                                                                                        ...
                                                                                                        <div class="col-lg-6 col-md-12">
                                                        <div class="boxed fn_toggle_wrap min_height_210px">
                                                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['backend_compact_product_list'][0], array( array('title'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__products_not_for_upload,'name'=>"not_related_products_".((string)$_smarty_tpl->tpl_vars['feed']->value->id),'products'=>$_smarty_tpl->tpl_vars['not_related_products']->value[$_smarty_tpl->tpl_vars['feed']->value->id],'label'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__add_products,'placeholder'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__hotline__select_products),$_smarty_tpl ) );?>
                                ...
                                <?php
$_smarty_tpl->tpl_vars['feed'] = $__foreach_feed_4_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            </div>
                        </div>
...
>
<?php }
/* smarty_template_function_category_select_6791571296926f3b9aa4398_24610724 */
if (!function_exists('smarty_template_function_category_select_6791571296926f3b9aa4398_24610724')) {
function smarty_template_function_category_select_6791571296926f3b9aa4398_24610724(Smarty_Internal_Template $_smarty_tpl,$params) {
