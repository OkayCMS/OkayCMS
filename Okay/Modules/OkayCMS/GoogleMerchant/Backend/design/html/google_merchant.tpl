                ...
                <div class="toggle_body_wrap on fn_card">
                        ...
                        <div class="permission_boxes row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span>{$btr->okaycms__google_merchant__upload_without_images|escape}</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="okaycms__google_merchant__upload_without_images" value='1' type="checkbox" {if $settings->okaycms__google_merchant__upload_without_images}checked=""{/if}/>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <div class="mb-1">
                                <input class="form-control" type="text" name="okaycms__google_merchant__company" value="{$settings->okaycms__google_merchant__company|escape}" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                            ...
                            <div class="mb-1">
                                <select name="okaycms__google_merchant__color" class="selectpicker form-control">
                                    ...
                                    {foreach $features as $feature}
                                        <option {if $settings->okaycms__google_merchant__color == $feature->id}selected=""{/if} value="{$feature->id}">{$feature->name|escape}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
