                                                                                    ...
                                                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                {if !$order->closed && $purchase->variant->stock_status == 'backorder'}
                                                                                                <div class="es-p5t" style="color: #000; font-size: 12px;font-weight: 600">{$lang->product_backorder|escape}</div>
                                                                                                {/if}
