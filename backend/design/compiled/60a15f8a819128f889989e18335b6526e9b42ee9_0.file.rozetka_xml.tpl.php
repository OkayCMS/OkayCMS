<?php
/* Smarty version 3.1.40, created on 2025-11-26 19:41:44
  from '/var/www/html/Okay/Modules/OkayCMS/Rozetka/Backend/design/html/rozetka_xml.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_69273bd89f9621_02102185',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '60a15f8a819128f889989e18335b6526e9b42ee9' => 
    array (
      0 => '/var/www/html/Okay/Modules/OkayCMS/Rozetka/Backend/design/html/rozetka_xml.tpl',
      1 => 1764098168,
      2 => 'file',
    ),
  ),
...
function content_69273bd89f9621_02102185 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'category_select' => 
  array (
    'compiled_filepath' => '/var/www/html/backend/design/compiled/60a15f8a819128f889989e18335b6526e9b42ee9_0.file.rozetka_xml.tpl.php',
    'uid' => '60a15f8a819128f889989e18335b6526e9b42ee9',
    'call_name' => 'smarty_template_function_category_select_26377896769273bd89d2890_76275178',
  ),
));
$_smarty_tpl->_assignInScope('meta_title', htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->rozetka_xml, ENT_QUOTES, 'UTF-8', true) ,false ,32);?>

<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->rozetka_xml, ENT_QUOTES, 'UTF-8', true);?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__params, ENT_QUOTES, 'UTF-8', true);?>
                        ...
                        <div class="permission_boxes row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__upload_without_images, ENT_QUOTES, 'UTF-8', true);?>
</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="okaycms__rozetka_xml__upload_without_images" value='1' type="checkbox" <?php if ($_smarty_tpl->tpl_vars['settings']->value->okaycms__rozetka_xml__upload_without_images) {?>checked=""<?php }?>/>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span class="permission_box__label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->upload_non_exists_products_to_rozetka, ENT_QUOTES, 'UTF-8', true);?>
</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="upload_non_available" value='1' type="checkbox" id="visible_checkbox" <?php if ($_smarty_tpl->tpl_vars['settings']->value->upload_only_available_to_rozetka) {?>checked=""<?php }?>/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="permission_box permission_box--long">
                                    <span class="permission_box__label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->use_full_description_to_rozetka, ENT_QUOTES, 'UTF-8', true);?>
</span>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="full_description" value="1" type="checkbox" id="featured_checkbox" <?php if ($_smarty_tpl->tpl_vars['settings']->value->use_full_description_in_upload_rozetka) {?>checked=""<?php }?>/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                                <strong><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__company;?>
</strong>
                            </div>
                            <div class="mb-1">
                                <input class="form-control" type="text" name="okaycms__rozetka_xml__company" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->okaycms__rozetka_xml__company, ENT_QUOTES, 'UTF-8', true);?>
" />
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__edit_and_add_feeds, ENT_QUOTES, 'UTF-8', true);?>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-info btn_big mb-1 fn_add_feed" type="submit" name="add_feed" value="1">
                            <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__add_feed;?>
</span>
                        </button>
                    </div>
                    <div class="col-md-12">
...
$__foreach_feed_0_saved = $_smarty_tpl->tpl_vars['feed'];
?>
...
" class="heading_box tab_navigation_link"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feed']->value->name, ENT_QUOTES, 'UTF-8', true);?>
                                    ...
                                    <?php
$_smarty_tpl->tpl_vars['feed'] = $__foreach_feed_0_saved;
}
                                                                ...
                                                                <div class="alert__content">
                                                                    <div class="alert__title">
                                                                        <?php if ((isset($_smarty_tpl->tpl_vars['errors']->value['feeds'][$_smarty_tpl->tpl_vars['feed']->value->id]['url']))) {?>
                                                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__error_url_exist, ENT_QUOTES, 'UTF-8', true);?>

                                                                        <?php } elseif ((isset($_smarty_tpl->tpl_vars['errors']->value['feeds'][$_smarty_tpl->tpl_vars['feed']->value->id]['url_cyrillic']))) {?>
                                                                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__error_url_cyrillic, ENT_QUOTES, 'UTF-8', true);?>
...
">
                                                                <span><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__remove_feed;?>
</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="heading_label">
                                                                <span>URL</span>
                                                                <i class="fn_tooltips" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__error_url_cyrillic, ENT_QUOTES, 'UTF-8', true);?>
">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="alert alert--icon alert--info">
                                                            <div class="alert__content">
                                                                ...
                                                                <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__generation_url, ENT_QUOTES, 'UTF-8', true);?>
 <a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_Rozetka_feed','url'=>$_smarty_tpl->tpl_vars['feed']->value->url,'absolute'=>1),$_smarty_tpl ) );?>
" target="_blank"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url_generator'][0], array( array('route'=>'OkayCMS_Rozetka_feed','url'=>$_smarty_tpl->tpl_vars['feed']->value->url,'absolute'=>1),$_smarty_tpl ) );?>
</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="heading_box">
                                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__upload_products, ENT_QUOTES, 'UTF-8', true);?>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="boxed match fn_toggle_wrap">
                                                            <div class="heading_box">
                                                                <?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__categories;?>

                                                                <button class="btn btn_small btn-info" name="add_all_categories" value="<?php echo $_smarty_tpl->tpl_vars['feed']->value->id;?>
"><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__select_all;?>
</button>
                                                                <button class="btn btn_small" name="remove_all_categories" value="<?php echo $_smarty_tpl->tpl_vars['feed']->value->id;?>
"><?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__select_none;?>
</button>
                                                            </div>
                                                            <div class="toggle_body_wrap on fn_card">
                                                        ...
                                                        <div class="boxed match fn_toggle_wrap">
                                                            <div class="heading_box">
                                                                <?php echo $_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__brands;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <div class="boxed fn_toggle_wrap min_height_210px">
                                                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['backend_compact_product_list'][0], array( array('title'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__products_for_upload,'name'=>"related_products_".((string)$_smarty_tpl->tpl_vars['feed']->value->id),'products'=>$_smarty_tpl->tpl_vars['related_products']->value[$_smarty_tpl->tpl_vars['feed']->value->id],'label'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__add_products,'placeholder'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__select_products),$_smarty_tpl ) );?>
                                                                                                        ...
                                                                                                        <div class="col-lg-6 col-md-12">
                                                        <div class="boxed fn_toggle_wrap min_height_210px">
                                                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['backend_compact_product_list'][0], array( array('title'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__products_not_for_upload,'name'=>"not_related_products_".((string)$_smarty_tpl->tpl_vars['feed']->value->id),'products'=>$_smarty_tpl->tpl_vars['not_related_products']->value[$_smarty_tpl->tpl_vars['feed']->value->id],'label'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__add_products,'placeholder'=>$_smarty_tpl->tpl_vars['btr']->value->okaycms__rozetka_xml__select_products),$_smarty_tpl ) );?>
...
>
<?php }
/* smarty_template_function_category_select_26377896769273bd89d2890_76275178 */
if (!function_exists('smarty_template_function_category_select_26377896769273bd89d2890_76275178')) {
function smarty_template_function_category_select_26377896769273bd89d2890_76275178(Smarty_Internal_Template $_smarty_tpl,$params) {
