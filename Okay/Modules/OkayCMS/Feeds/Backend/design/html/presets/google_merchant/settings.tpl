    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__company}</span>
            </div>
            <div class="mb-1">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__adult|escape}</span>
                        </label>
...
<div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__color}</span> <span>({$btr->okay_cms__feeds__feed__settings__google_merchant__color_notify})</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__upload_without_images|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__upload_only_in_stock_products|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__no_export_without_price|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__use_variant_name_like_size|escape}</span>
                        </label>
                        <label class="switch switch-default">
    ...
    <div class="heading_box mb-2">
        ...
        <div class="col-md-12 mb-q">
            <div class="row">
                <div class="col-md-12">
                    {* <div class="heading_label">
                        <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price}</span>
                    </div> *}
                    <div class="row">
                        {* <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price_price}" disabled>
                        </div> *}
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_price][operator]">
                                <option value="<" {if $feed->settings['filter_price']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_less}</option>
                                <option value=">" {if $feed->settings['filter_price']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_large}</option>
                                <option value="=" {if $feed->settings['filter_price']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price_price} {$btr->okay_cms__feeds__feed__settings_equality_equally1}</option>
                            </select>
                        </div>
                        <div class="col-xs-6 col-md-5 col-lg-4 col-lg-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_price][value]" value="{$feed->settings['filter_price']['value']}" placeholder="{$btr->okay_cms__feeds__feed__settings_equality_place_price}">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    {* <div class="heading_label">
                        <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock}</span>
                    </div> *}
                    <div class="row">
                        {* <div class="col-md-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock_stock}" disabled>
                        </div> *}
                        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
                            <select class="selectpicker form-control mb-1" name="settings[filter_stock][operator]">
                                <option value="<" {if $feed->settings['filter_stock']['operator'] === '<'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_less}</option>
                                <option value=">" {if $feed->settings['filter_stock']['operator'] === '>'} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_large}</option>
                                <option value="=" {if $feed->settings['filter_stock']['operator'] === '='} selected {/if}>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock_stock} {$btr->okay_cms__feeds__feed__settings_equality_equally2}</option>
                            </select>
                        </div>
                        <div class="col-xs-6 col-md-5 col-lg-4 col-lg-4">
                            <input class="form-control mb-1" type="text" name="settings[filter_stock][value]" value="{$feed->settings['filter_stock']['value']}" placeholder="{$btr->okay_cms__feeds__feed__settings_equality_place_count}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-6 col-md-5 col-lg-4 pr-0 pr-0--feed">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__price_change}</span>
                <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed__settings__google_merchant__price_change_tooltip|escape}">
