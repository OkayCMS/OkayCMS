    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__google_merchant__company}</strong>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__google_merchant__color}</strong> <span>({$btr->okay_cms__feeds__feed__settings__google_merchant__color_notify})</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_price}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="heading_label">
                        <strong>{$btr->okay_cms__feeds__feed__settings__google_merchant__filter_stock}</strong>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="col-md-6 mb-1">
            <div class="heading_label">
                <strong>{$btr->okay_cms__feeds__feed__settings__google_merchant__price_change}</strong>
