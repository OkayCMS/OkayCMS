...
{
    public const PRODUCT_ROUTE_TEMPLATE      = 'product_routes_template';
    ...
    public const TYPE_NO_PREFIX_AND_CATEGORY = 'no_prefix_and_category';
    public const SLASH_END                   = 'product_routes_template_slash_end';
