        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__prom_ua__description_in_html|escape}</span>
                            <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed__settings__prom_ua__description_in_html_info|escape}">
