...
<div class="boxed">
    ...
    <div class="alert alert--icon alert--info fn_features_settings_alert">
        <div class="alert__content">
            ...
            <p>{$btr->okay_cms__feeds__feed__settings__title2_rosetka_documentation}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__gtin}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__material}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__google_merchant__description_in_html|escape}</span>
                            <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed__settings__google_merchant__description_in_html_info|escape}">
