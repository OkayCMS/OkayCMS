...
class YandexXMLVendorModelRelationsEntity extends Entity
{
    ...
    protected static $table = 'okaycms__yandex_xml_vendor_model__relations';

    protected static $tableAlias = 'yxvmr';
